...
export const STAGE_STYLES = {
  ...
  "Under submission": {
    ...
    dot: "bg-blue-500 rounded-full",
  },
  "To be discussed": {
    chip: "bg-violet-50 text-violet-800 border-violet-200",
    dot: "bg-violet-500 rounded-full",
  },
  "Sent to IFD": {
    chip: "bg-indigo-50 text-indigo-800 border-indigo-200",
    dot: "bg-indigo-500 rounded-full",
  },
  "Comments awaited": {
    chip: "bg-cyan-50 text-cyan-800 border-cyan-200",
    dot: "bg-cyan-500 rounded-full",
  },
  Approved: {
  ...
  "Draft Issued": {
    ...
    dot: "bg-sky-500 rounded-full",
  },
  "In Abeyance": {
    chip: "bg-orange-50 text-orange-800 border-orange-200",
    dot: "bg-orange-500 rounded-full",
  },
  "No Action needed": {
