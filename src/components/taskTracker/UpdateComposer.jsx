    ...
    "
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-3 py-2 rounded-lg border border-slate-200 text-xs lg:text-sm focus:outline-none focus:ring-2 focus:ring-slate-300 font-thin lg:font-normal"
            />
          </div>
            ...
            >
              {status === "saving" ? (
                <span className="inline-flex items-center justify-center gap-2">
                  <span className="h-4 w-4 rounded-full border-2 border-white/60 border-t-white animate-spin font-thin lg:font-normal" />
                  Saving…
                </span>
              ) : status === "saved" ? (
                "Saved ✓"
