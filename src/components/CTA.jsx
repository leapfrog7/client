...
export default function CTA({ isLoggedIn = false, onStartTrial }) {
  ...
  return (
    <section aria-labelledby="cta-heading" className="w-full bg-white">
      <div className="flex flex-col md:flex-row items-center justify-center p-2 gap-10 lg:gap-14 max-w-7xl mx-auto">
        {/* Text */}
        <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
          {/* <p className="inline-flex items-center rounded-full border border-cyan-100 bg-cyan-50 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-cyan-800">
          ...
          <div className="mt-0 lg:mt-4">
            ...
            >
              ...
              <span className="block mt-1">
                <motion.span
                  className="inline-block text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-pink-500 to-purple-500"
          ...
          <motion.ul
            ...
            whileInView="show"
            viewport={{ once: true, amount: 0.3 }}
            className="mt-6 space-y-4 lg:space-y-5 w-full"
            aria-label="Key benefits"
          >
            <motion.li
              variants={item(0.05)}
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center">
          ...
          <div className="mt-5 text-center w-full max-w-sm">
            <p className="text-gray-600 text-sm leading-relaxed">
              See your analytics, progress and bookmarked questions in one clean
              dashboard.
            </p>
          </div>
        </div>
